---
title: "Modal.Period"
url: "https://modal.com/docs/reference/modal.Period"
...
**Source:** [https://modal.com/docs/reference/modal.Period](https://modal.com/docs/reference/modal.Period)  
...
# modal.Period <a id="modalperiod"></a>
```
...
This behaves similar to the package.
```
def __init__(
  self,
  years: int = 0,
