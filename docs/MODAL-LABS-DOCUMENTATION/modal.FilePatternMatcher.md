---
title: "Modal.Filepatternmatcher"
url: "https://modal.com/docs/reference/modal.FilePatternMatcher"
...
**Source:** [https://modal.com/docs/reference/modal.FilePatternMatcher](https://modal.com/docs/reference/modal.FilePatternMatcher)  
...
- [You can also negate the matcher.](#you-can-also-negate-the-matcher)
  - [from_file](#fromfile)
...
# modal.FilePatternMatcher <a id="modalfilepatternmatcher"></a>
```
...
# You can also negate the matcher. <a id="you-can-also-negate-the-matcher"></a>
...
```
 modal.FilePatternMatcher (https://modal.com/docs/reference/modal.FilePatternMatcher# modalfilepatternmatcher)from_file (https://modal.com/docs/reference/modal.FilePatternMatcher# from_file)
