...
**Source:** [https://modal.com/docs/reference/modal.Cron](https://modal.com/docs/reference/modal.Cron)  
...
# modal.Cron <a id="modalcron"></a>
```
class Cron(modal.schedule.Schedule)
```
 Cron jobs are a type of schedule, specified using the syntax.
